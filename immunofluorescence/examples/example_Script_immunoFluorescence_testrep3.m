...
%% Variables
% directories
experimentDir = 'D:\2019-08-03-E14-DNA-seqFISH+rep3-1-plate2';
experimentFiduciaryDir = 'I:\2019-07-29-E14-DNA-seqFISH+rep3-1-DNAFISH';
experimentName = '2019-08-03-E14-DNA-seqFISH+rep3-1-plate2';
experimentLabel = '01-31-2019-test-pos0'; % Label for save folder in 'analysis'
...
posArray = 0:5; % array of positions
posArrayChaTform = 0:4; % array for fiduciary marker images
folderArray = 0:13; % folder array to align, process, decode
...
for position = posArray
    ...
    experimentLabel = '02-03-2019-bin1x1x1';
    binSize = 1;
    avgintpercell(experimentDir, experimentName, experimentLabel, I(:,immunoChArray), ...
        L, position, folderArray, immunoChArray, segoption, binSize);
    ...
    experimentLabel = '02-03-2019-bin2x2x1';
    binSize = 2;
end