...
%% Variables
% directories
experimentDir = 'L:\2020-01-25-E14L22Rik24hr-RNAFISH-IF';
experimentFiduciaryDir = 'L:\2020-01-25-E14L22Rik24hr-RNAFISH-IF';
...
posArray = 0:7; % array of positions
posArrayChaTform = 0:4; % array for fiduciary marker images
folderArray = 0:11; % folder array to align, process, decode
