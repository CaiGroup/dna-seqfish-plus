...
% nicogpt@caltech.edu
    ...
    [useBackgroundImages, backgroundFolderName, RNARefPath, imageJBackSubtract, subtractBackground, ...
        saveProcessedHybIms, divideIms, dim, finalFixedPath, finalMovingPath, alignCh] = optargs{:};
    ...
    [hybIms, dapiIms, dapiTform, numCh, ~] = alignimmunoimages(experimentName, experimentDir, folderArray, position, saveDir, tform2ref, RNARefPath, true, false, divideIms, dim, alignCh);
