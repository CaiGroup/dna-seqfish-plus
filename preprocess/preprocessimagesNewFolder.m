function [I, hybIms, dapiTform] = preprocessimagesNewFolder(experimentName, experimentDir, ...
...
% nicogpt@caltech.edu
    ...
    [hybIms, dapiIms, dapiTform, numCh] = aligndapiimagesNewName(experimentName, experimentDir, folderArray, position, saveDir, dapiRefPath, true, false, divideIms, dim);
