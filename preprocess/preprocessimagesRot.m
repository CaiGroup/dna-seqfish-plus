function [I, hybIms, dapiTform] = preprocessimagesRot(experimentName, experimentDir, ...
...
% 
% correct rotation after usual tform alignment by applying global rotation
% tfrom, calculated from aligned refDAPI vs hyb1DAPI.
%
% Date: 01/07/2020
% Author: Yodai Takei
% ytakei@caltech.edu
    ...
    optargs = {true, 'initial_background', 'HybCycle_0', true, false, false, false, '3d'}; 
    optargs(1:numvarargs) = varargin;
    % Place optional args in memorable variable names
    [useBackgroundImages, backgroundFolderName, dapiRefPath, imageJBackSubtract, subtractBackground, ...
        saveProcessedHybIms, divideIms, dim] = optargs{:};
    ...
    [hybIms, dapiIms, tformDapiRot] = aligndapiimagesRotglobal(experimentName, ...
    folderArray, position, saveDir, hybIms, dapiIms, dapiRefPath);
    saveDapiTformPath2 = fullfile(saveDir, ['dapi-rotation-tform-' experimentName '-' endingDateString '.mat']);
    save(saveDapiTformPath2, 'tformDapiRot');
