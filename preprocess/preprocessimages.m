function [I, hybIms, dapiTform] = preprocessimages(experimentName, experimentDir, ...
...
% nicogpt@caltech.edu
    ...
    if useBackgroundImages % NEEDS DEBUGGIN - ERROR HERE at line ,159
        ...
        listing = dir([backImBasePath '\*MMStack_Pos' num2str(position) '.ome.tif']);
        if length(listing) == 1
        ...
        if exist(backImPath, 'file') == 2
            ...
            if numCh == 3
                ...
                I2 = I(:,2);
                I3 = I(:,3);
                save(savePath, 'I1', 'I2', 'I3', 'backIms', 'backTform', 'dapiTform', 'shadingcorr', 'position','-v7.3');
                clearvars I1 I2 I3
            else
        ...
        if imageJBackSubtract % no need to save if no background subtraction is used; only need hybIms from aligndapiimages
            ...
            if numCh == 3
                ...
                I2 = I(:,2);
                I3 = I(:,3);
                save(savePath, 'I1', 'I2', 'I3', 'dapiTform', 'position','-v7.3');
                clearvars I1 I2 I3
            else
