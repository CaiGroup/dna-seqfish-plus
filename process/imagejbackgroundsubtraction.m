...
% Date: 1/29/2019
    ...
    optargs = {'tempProcessed', [], 3, false, false}; % default of using 7 x 7 pixel grid for gaussian function
    ...
    [uniqueString, fijiDirectory, pixelRadius, sliding, despeckle] = optargs{:};
