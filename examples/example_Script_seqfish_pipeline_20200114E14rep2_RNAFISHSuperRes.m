...
experimentLabel = '2020-01-14-seqential-analysis';
...
for position = posArray
    listing = dir(['E:\Yodai\DNAFISH+\2019-07-06-E14-DNA-seqFISH+rep2-2-RNAFISH-IF - Swapped\processedimages\pos' num2str(position) '\preProcessedData*RNAFISH-2020*.mat']);
