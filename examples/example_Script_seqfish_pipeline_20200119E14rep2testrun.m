...
experimentLabel = '2020-01-21-pipeline-test-4';
posArray = 0; % for decoding. needs Pos0 anyway. Don't start from Pos1 or later.
posArrayAll = 0;% for fiducial markers.
