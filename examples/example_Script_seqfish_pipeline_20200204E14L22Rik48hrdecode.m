...
% edit by Yodai Takei
% Last updated on 02/04/20.

%% Experiment dependent Variables
addpath('C:\Users\Long Cai - 1\Desktop\Fiji.app\scripts');
experimentDir = 'F:\Yodai\DNA+\2019-10-29-E14-L22Rik-48hr-DNAFISHIF';
experimentName = '2019-10-29-E14-L22Rik-48hr-DNAFISHIF';
experimentLabel = '2020-02-05-full-decoding';
posArray = 2:7; % for decoding. needs Pos0 anyway. Don't start from Pos1 or later.
posArrayAll = 0:7;% for fiducial markers.
sizeZ = 29; % number of z slices. in the future, this should be automatically calculted.
...
%    'numChannels', 'sqrtradius', 'minseeds', 'alloweddiff', 'usechabboffsets', 'usephysicaloffsets', ...
...
for position = posArray
    ...
    'filtersigma', 'numRefPoints', 'medRefIntensity', 'longestEdges', 'minEdgeMatch', ...
    'minDotMatch', 'finalpoints', 'segment', 'minseeds', 'numCh3pointshyb', 'I3paint',...
