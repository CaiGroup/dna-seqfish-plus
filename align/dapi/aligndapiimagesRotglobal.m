function [hybIms, dapiIms, tformDapiRot, numZSlice] = aligndapiimagesRotglobal(experimentName, ...
...
% ytakei@caltech.edu
    ...
    for folder = 1:length(folderArray)
            ...
            if folder == 1
                ...
                tformDapiRot = grabtformRot(newIm, newImRef, initialRadius, numIterations);
                tformDapiUse = tformDapiRot;
            end
