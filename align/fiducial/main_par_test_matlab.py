...
home_dir = 'I:\\2019-07-21-E14-DNA-seqFISH+rep2-2-DNAFISH - Swapped\\analysis\\12-19-2019-pipeline-test\\points'
ref_fname = 'ref-points-pos%d-initial_fiducial_markers-12-19-2019-pipeline-test.csv' % position
ro_fname = 'hyb-points-pos%d-2019-07-21-E14-DNA-seqFISH+rep2-2-DNAFISH - Swapped-12-19-2019-pipeline-test.csv' % position
savefname = 'offsets_pos%d' % position
#savefname = '20191202_'
datestr = dt.strftime(dt.now(), '%Y%m%d')
#paramstr = 'xyse%s_zse%s_xyte%s_zte%s_xyme%s_zme%s.csv'

n_longest_edges = 200 # E14 20; brain = 200
xy_search_error = 3
z_search_error = 3
...
xy_match_error = 1
z_match_error = 1
min_edge_match = 5 # no more than 10%-20% NOT < 3; brain = 10
min_dot_matches = 10 # E14 10; brain = 20 or 50 (half amount of fiducial markers)
min_bright_prop = 0.2
max_bright_prop = 2
